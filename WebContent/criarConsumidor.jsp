...
<body onload="carregaCursos();carregaDepartamentos()">
	...
	<input type="hidden" name="acao" value="Criar" id="acao"/>
		<p>Selecione o tipo de Consumidor: 
			<input type="radio" name="tipo"  id="tipoAluno" value="aluno" checked="checked" onclick="$('#camposAluno').show(); $('#camposFuncionario').hide()"/>Aluno
			<input type="radio" name="tipo" id="tipoFuncionario" value="funcionario" onclick="$('#camposAluno').hide(); $('#camposFuncionario').show()"/>Funcionario
		</p>
